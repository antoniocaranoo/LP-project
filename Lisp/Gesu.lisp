...
;quando non ha piu' nulla da controllare della sottoclasse rispetto ai 
;parent, unisce i nuovi fields specificati a quelli puramente ereditati
		  ...
		  (if (and (not (= (count-elements (cdaar c-input-l)) 2)) (null       
			   ...
			   (= (count-elements (car s-parent-l)) (count-elements 
				    ...
				    (list (append (car c-input-l) (cadr s-parent-l)))))
                      ...
                      (append (cons (append (car c-input-l) (car s-parent-l))
				    (append (cadr c-input-l) (cadr s-parent-l))))
                      ))))
	  ...
	  c-input-l
		 ...
		 (parts-to-be-inherited (cddr s-input-l) 
                ...
                (t (parts-to-be-inherited (cddr s-input-l) 
					  (cons (field-remover (car s-input-l)   
							       (car s-parent-l))
						(method-replacer (cadr s-input-l) (cadr s-parent-l)))
					  c-input-l))))))
  ...
  (if (null s-input-l)
      ...
      (if (null s-parent-l)
          ...
          (make-parts-to-be-inherited (cddr s-input-l)
                                      (list (field-remover (car s-input-l) (car s-parent-l))
